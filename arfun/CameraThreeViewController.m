...
#import "CameraThreeViewController.h"

@interface CameraThreeViewController ()

@end

@implementation CameraThreeViewController
...
- (void)setupTracker
{
    ...
    ARImageTrackable *imageTrackable = [[ARImageTrackable alloc] initWithImage:[UIImage imageNamed:@"face.png"] name:@"spaceMarker"];
