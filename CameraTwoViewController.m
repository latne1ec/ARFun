...
#import "CameraTwoViewController.h"

@interface CameraTwoViewController ()

@end

@implementation CameraTwoViewController
...
- (void)setupTracker {
    ...
    ARImageTrackable *imageTrackable = [[ARImageTrackable alloc] initWithImage:[UIImage imageNamed:@"bkg.jpg"] name:@"spaceMarker"];
